...
interface Project { title: string; category: string; year: string; description: string; preview: string; previewSecondary: string; images: string[]; url: string; stack: string; }

const projects: Project[] = [
  { title: "Sayqa", category: "E-commerce", year: "2025", description: "Una experiencia de compra para medicina natural: catálogo, carrito y pagos conectados en un recorrido simple y confiable.", preview: "/img/previews/ecommerce/1.webp", previewSecondary: "/img/previews/ecommerce/2.webp", images: ["/img/ecommerce/1.png", "/img/ecommerce/2.png", "/img/ecommerce/3.png", "/img/ecommerce/10.png"], url: "https://sayqamedicinanatural.com/", stack: "Next.js · Nest.js · MySQL" },
  { title: "Sistema ERP", category: "Producto SaaS", year: "2025", description: "Inventario, ventas, finanzas y analítica en tiempo real reunidos en un sistema operativo claro para el negocio.", preview: "/img/previews/erp/1.webp", previewSecondary: "/img/previews/erp/2.webp", images: ["/img/erp/1.png", "/img/erp/2.png", "/img/erp/3.png", "/img/erp/6.png"], url: "https://erp-sistemadeventa-web.vercel.app/", stack: "Next.js · Nest.js · PostgreSQL" },
  { title: "Residencia", category: "Aplicación móvil", year: "2025", description: "Una herramienta de campo para inmobiliarias que organiza propiedades, captaciones y clientes sin fricción.", preview: "/img/previews/inmobiliaria/1.webp", previewSecondary: "/img/previews/inmobiliaria/2.webp", images: ["/img/inmobiliaria/1.png", "/img/inmobiliaria/2.png", "/img/inmobiliaria/3.png"], url: "https://residencia-consultor-ls6s.glide.page", stack: "Glide Apps · Mobile" },
  { title: "Escudaría", category: "Juego Android", year: "2024", description: "Aprendizaje y juego se encuentran en una experiencia interactiva creada para mantener la curiosidad en movimiento.", preview: "/img/previews/Escudaria/1.webp", previewSecondary: "/img/previews/Escudaria/2.webp", images: ["/img/Escudaria/1.jpeg", "/img/Escudaria/2.jpeg", "/img/Escudaria/3.jpeg", "/img/Escudaria/4.jpeg"], url: "https://play.google.com/store/apps/details?id=com.webcody.escudaria&pcampaignid=web_share", stack: "Unity · C# · Android" },
  { title: "Becerra", category: "Web corporativa", year: "2024", description: "Una presencia digital sobria y visual para una constructora que necesitaba transmitir precisión antes del primer contacto.", preview: "/img/previews/Becerra/1.webp", previewSecondary: "/img/previews/Becerra/2.webp", images: ["/img/Becerra/1.png", "/img/Becerra/2.png", "/img/Becerra/4.png", "/img/Becerra/6.png"], url: "https://becerraconstrucciones.com/", stack: "HTML · CSS · JavaScript" },
  { title: "Amulek", category: "Web corporativa", year: "2024", description: "Arquitectura, obra y servicios presentados mediante una experiencia institucional directa, cálida y fácil de recorrer.", preview: "/img/previews/Amulek/1.webp", previewSecondary: "/img/previews/Amulek/2.webp", images: ["/img/Amulek/1.png", "/img/Amulek/2.png", "/img/Amulek/4.png", "/img/Amulek/8.png"], url: "https://amulekconstrucciones.com/", stack: "HTML · CSS · JavaScript" },
];
    ...
    return (
      <article className={`${span} glass-edge group relative grid overflow-hidden rounded-[30px] lg:min-h-[560px] lg:grid-cols-[.68fr_.32fr]`}>
        <button onClick={onOpen} className="relative min-h-[300px] overflow-hidden bg-[#070913] text-left md:min-h-[360px]" aria-label={`Abrir galería de ${project.title}`}>
          ...
          <div className="absolute left-[8%] right-[8%] top-[10%] h-[78%] rotate-[-3deg] overflow-hidden rounded-[24px] border border-white/10 opacity-35 transition-transform duration-700 group-hover:-translate-x-5 group-hover:-rotate-[6deg]"><img src={project.previewSecondary} alt="" loading="lazy" decoding="async" className="h-full w-full object-cover object-top" /></div>
          <div className="absolute left-[5%] right-[4%] top-[12%] h-[76%] overflow-hidden rounded-[24px] border border-white/[.16] bg-[#0a0c14] p-2 shadow-[0_45px_110px_rgba(0,0,0,.6)] transition-transform duration-700 group-hover:-translate-y-3 group-hover:rotate-[1deg]">
            ...
            <img src={project.preview} alt={`Vista principal de ${project.title}`} loading="lazy" decoding="async" className="h-[calc(100%-1.75rem)] w-full rounded-[17px] object-cover object-top" />
          </div>
